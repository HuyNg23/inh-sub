...
namespace IBox.LogService.Controller
{
    ...
    public class ConfigController : ControllerBase
    {
        ...
        {
            _globalConfig.OnLoad("LogService");
        ...
        public ResponseForm<dynamic> GetConfiguration()
        {
            ...
            return new ResponseForm<dynamic>(() =>
            {
                return new
                {
                    site = $"{IBGlobalConfig.ThisSite} - Log service",
        ...
        {
            //Call API đến server còn lại
            var token = Request.Headers["Authorization"];
            List<ConfigChat> cB_ConfigChats = new List<ConfigChat>();
            var chatBotService = IBGlobalConfig.LogServiceIBox.Where(ptr => !ptr.Contains(IBGlobalConfig.ThisSite));
