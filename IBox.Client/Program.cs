...
{
    rootContext.Context.SyncDatabaseSchemaRoot();
    ...
    sqlDependency.SqlDependencyStartService("ClientBEService");
...
var tenantContext = app.Services.CreateScope().ServiceProvider.GetService<IBContext<TenantContext>>();
if (tenantContext != null)
{
    tenantContext.Context.SyncDatabaseSchema();
}
...
gConfig.OnLoad("ClientBEService");
