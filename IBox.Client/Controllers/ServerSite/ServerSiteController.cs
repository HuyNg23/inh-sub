...
namespace IBox.Client.Controllers.ServerSite
{
    ...
    {
        [HttpPost("GetAllServerSite/{pageNumber}")]
        public ResponseForm<List<S_ServerSite>> GetAllServerSite(RequestForm<dynamic> req, int pageNumber)
        {
