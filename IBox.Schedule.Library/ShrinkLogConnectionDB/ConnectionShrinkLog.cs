    ...
    public class ConnectionShrinkLog : IConnectionShrinkLog
    {
        ...
        public bool CheckConnectSQL(DBConnectionShrinkLog dBConnection)
        {
            try
            {
                ...
                {
                    throw new IboxLog($"Address can't null or empty.", "AppLogs");
                }
        ...
        public List<LogSpaceInfoDatabase> GetLogSpaceInfoDatabase()
        {
            try
            {
                ...
                var dbRoot = _configuration.Config.Value.Database.Main.DatabaseName ?? string.Empty;
            ...
            {
                throw new IboxLog($"GetLogSpaceInfoDatabase an unexpected error has occurred: {ex.Message}", "AppLogs", ex);
            }
        }
        ...
        public List<Category> GetAllCategory()
        {
            ...
            string dbRoot = _configuration.Config.Value.Database.Main.DatabaseName ?? "";
